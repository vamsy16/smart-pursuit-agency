...
|---|---|---|---|
| **PB-01** | New-lead intake & scoring | form submitted / reply | scored lead + drafted first reply | · [`file`](PB-01-intake-scoring.md) ●
...
| **PB-12** | Weekly digest | Fri 16:00 | 5-block digest + the client's report file | · [`file`](PB-12-weekly-digest.md) ●
...
| **PB-18** | Autopsy (public teardown) | weekly | `site/autopsies/NN-<anon>.html`, scrubbed + self-contained | · [`file`](PB-18-growth-autopsy.md) ●
| **PB-19** | Outbound list build & personalise | Tue/Thu | 4-touch sequence + the named teardown (vault) | · [`file`](PB-19-outbound-sequence.md) ●
